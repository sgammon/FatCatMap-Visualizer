package fatcatmap.components.preloader
{
	...
	{
		//~ Settings ----------------------------------------------------------
		private static var _BarWidth     : int = 189;  // Progress bar width
		private static var _BarHeight    : int = 8;   // Progress bar height
		private static var _LogoHeight   : int = 49;   // Logo picture height
		private static var _LogoWidth    : int = 189;  // Logo picture width
		private static var _Padding      : int = 20;   // Spacing between logo and progress bar
		private static var _LeftMargin   : int = 0;    // Left Margin
		private static var _RightMargin  : int = 0;    // Right Margin
		private static var _TopMargin    : int = 0;    // Top Margin
		private static var _BottomMargin : int = 0;    // Bottom Margin
		
		private static var _BarBackground  : uint = 0xFAF9E8; // background of progress bar
		private static var _BarOuterBorder : uint = 0xFAF9E8; // color of outer border
		private static var _BarColor       : uint = 0x7EBCC2; // color of prog bar
		private static var _BarInnerColor  : uint = 0xFAF9E8; // old: 0x67A1A8 inner color of prog bar
		
		//~ Instance Attributes -----------------------------------------------
		[Embed(source="/assets/fatcatmap.png")]
